...
export default function FAQ() {
    ...
    const faqs = [
        {
            id: 1,
            question: "Mon animal nécessite des soins médicaux, puis-je utiliser Mamipet ?",
            answer:
        ...
        {
            id: 2,
            question: "Comment vérifiez-vous les compétences des pet‑sitters ?",
            answer:
        ...
        {
            id: 3,
            question: "Que se passe‑t‑il en cas de problème pendant la garde ?",
            answer:
